<!DOCTYPE html>
<html lang="id">
<?php $pageTitle = 'Tambah Pemasokan — Admin StockMate'; require_once ROOT . '/views/layout/header.php'; ?>
<body>
<div class="layout">
    ...
    <main class="main-content">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= BASE_URL ?>/admin/pemasokan/simpan" method="POST">
                        <div class="form-grid">
                        ...
                        <div style="padding:20px 0 0;border-top:1px solid #e2e8f0;margin-top:20px;display:flex;justify-content:flex-end;gap:10px;">
                            <a href="<?= BASE_URL ?>/admin/pemasokan" class="btn-secondary">Batal</a>
